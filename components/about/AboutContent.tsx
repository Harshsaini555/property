...
const AboutContent = () => {
  return (
    <div className="pt-32">
      ...
      <section className="relative bottom-10  h-96 bg-cover bg-center" style={{
      ...
      <section className="py-16 bg-blue-50">
        <div className="container mx-auto px-4 lg:px-10 text-center">
          ...
          <a
            href="/contact"
            className="inline-block bg-orange-100 text-black px-8 py-4 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transition-all hover:scale-105"
          >
            Contact Us Now
          </a>
        </div>

...
const MapsContent: React.FC<MapsContentProps> = ({ cards }) => {
    ...
    <div className="pt-32">
      ...
      <section className="relative h-96 bg-gradient-to-r from-blue-600 to-purple-600 flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          >
            Across Noida, Greater Noida & YEIDA
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Select your region to view available property maps
          </motion.p>
        </div>
      </section>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 rounded-2xl border border-gray-200 focus:ring-2 focus:ring-blue-600 focus:border-transparent outline-none text-lg"
              />
            </div>
          </div>
        </div>
